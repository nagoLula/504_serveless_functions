...
- Azure Function: [https://potassiumfunc504-hqcfd8ebhhdfdxd0.eastus2-01.azurewebsites.net/api/potassium](https://potassiumfunc504-hqcfd8ebhhdfdxd0.eastus2-01.azurewebsites.net/api/potassium)
...
![Function App Overview](https://github.com/user-attachments/assets/b86b81e6-741c-4412-afcb-b354a9c7652a)

### 2. Creating the HTTP Trigger

![Create Function Trigger](https://github.com/user-attachments/assets/46fe5dcd-278e-40d3-ad65-7e0e8322adf8)

### 3. Uploading Code via Code + Test

![Code + Test Panel](https://github.com/user-attachments/assets/ae489d44-f724-4987-9056-a1425d67b18f)
...
![Deployment Screenshot](https://github.com/user-attachments/assets/8e03ef83-d0f8-4640-8eba-edea4ea7b44e)
